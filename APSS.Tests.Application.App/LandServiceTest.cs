...
public sealed class LandServiceTest
{
        ...
        bool shouldSucceed = true)
    {
        ...
        if (accessLevel == AccessLevel.Farmer && permissions == PermissionType.Create)
        {
    ...
    [InlineData(AccessLevel.Governorate, PermissionType.Create | PermissionType.Read | PermissionType.Delete | PermissionType.Update, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Create | PermissionType.Read | PermissionType.Delete | PermissionType.Update, false)]
    [InlineData(AccessLevel.Farmer, PermissionType.Create | PermissionType.Read | PermissionType.Delete | PermissionType.Update, false)]
    ...
    [Theory]
    [InlineData(AccessLevel.Farmer, PermissionType.Create, true)]
    [InlineData(AccessLevel.Farmer, PermissionType.Delete | PermissionType.Read | PermissionType.Update, false)]
    [InlineData(AccessLevel.Group, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Village, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Directorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Governorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Root, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.District, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
        ...
        bool shouldSucceed = true)
    {
        ...
        var anotherAccount = await _uow.CreateTestingAccountAsync(accessLevel, permissionType);

        if (accessLevel == AccessLevel.Farmer && permissionType == PermissionType.Create)
        {
            await Assert.ThrowsAsync<InsufficientPermissionsException>(() =>
    ...
    [InlineData(AccessLevel.Farmer, PermissionType.Create | PermissionType.Read | PermissionType.Update, false)]
    [InlineData(AccessLevel.Group, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Village, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Directorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Governorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    ...
    [InlineData(AccessLevel.District, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    public async Task LandRemovedTheory(
        ...
        bool shouldSucceed)
    {
        ...
        account = await _uow.CreateTestingAccountForUserAsync(account.User.Id, permissions);
        var otherAccount = await _uow.CreateTestingAccountAsync(accessLevel, permissions);

        if (accessLevel == AccessLevel.Farmer && permissions == PermissionType.Delete)
        {
            await Assert.ThrowsAsync<InsufficientPermissionsException>(() =>
    ...
    [InlineData(AccessLevel.District, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    public async Task LandProductExpenseRemovedTheory(
        AccessLevel accessLevel,
        PermissionType permissions,
        bool shouldSucceed)
    {
        ...
        {
            await Assert.ThrowsAsync<InsufficientPermissionsException>(() =>
            _landSvc.RemoveLandProductExpenseAsync(otherAccount.Id, landProductExpense!.Id));
        }
        else if (accessLevel != AccessLevel.Farmer)
        {
            await Assert.ThrowsAsync<InvalidAccessLevelException>(() =>
        ...
        var removeLandProductExpenseTask = _landSvc.RemoveLandProductExpenseAsync(account.Id, landProductExpense!.Id);

        if (!shouldSucceed && accessLevel == AccessLevel.Farmer)
        {
            await Assert.ThrowsAsync<InvalidAccessLevelException>(async () => await removeLandProductExpenseTask);
            return;
        }

        await removeLandProductExpenseTask;
        Assert.False(await _uow.ProductExpenses.Query().ContainsAsync(landProductExpense));
    }
        ...
        bool shouldSucceed)
    {
        ...
        if (accessLevel == AccessLevel.Farmer && permissionType == PermissionType.Delete)
        {
            await Assert.ThrowsAsync<InsufficientPermissionsException>(() =>
    ...
    [InlineData(AccessLevel.Root, PermissionType.Create | PermissionType.Read | PermissionType.Update, false)]
    [InlineData(AccessLevel.Group, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Village, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Directorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Governorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Farmer, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.District, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
        ...
        bool shouldSucceed)
    {
        ...
        var differentAccount = await _uow.CreateTestingAccountAsync(accessLevel, permissionType);
        ...
        if (!shouldSucceed && accessLevel == AccessLevel.Root)
        {
    ...
    [InlineData(AccessLevel.Farmer, PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Group, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Village, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Directorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Governorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
        ...
        bool shouldSucceed)
    {
        ...
        if (accessLevel == AccessLevel.Farmer && permissionType == PermissionType.Update)
        {
            await Assert.ThrowsAsync<InsufficientPermissionsException>(() =>
    ...
    [Theory]
    [InlineData(AccessLevel.Root, PermissionType.Update, true)]
    [InlineData(AccessLevel.Root, PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Group, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Village, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Directorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Governorate, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    ...
    [InlineData(AccessLevel.District, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    [InlineData(AccessLevel.Presedint, PermissionType.Update | PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    public async Task LandProductExpenseUpdatedTheory(
        AccessLevel accessLevel = AccessLevel.Farmer,
    ...
    //[InlineData(PermissionType.Update, true)]
    //[InlineData(PermissionType.Create | PermissionType.Read | PermissionType.Delete, false)]
    //public async Task LandProductExpenseUpdatedTheory(PermissionType permissionType, bool shouldSucceed)
    //{
    //    var (account, landProductExpense) = await LandProductExpenseAddedTheory();
    //    var templateProductExpense = ValidEntitiesFactory.CreateValidProductExpense();
