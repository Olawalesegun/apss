...
public interface IConfigurationService
{
    ...
    /// <summary>
    /// Gets a string value from the configuration dictionary, using a default value if the key does
    /// not exist
    /// </summary>
    ...
    /// <summary>
    /// Gets an integer value from the configuration dictionary, using a default value if the key
    /// does not exist
    /// </summary>
    /// <param name="key">The key of the configuration entry to get</param>
    /// <param name="defaultValue">The default value</param>
    ...
    /// <summary>
    /// Gets a double value from the configuration dictionary, using a default value if the key does
    /// not exist
    /// </summary>
    /// <param name="key">The key of the configuration entry to get</param>
    /// <param name="defaultValue">The default value</param>
    ...
    /// <summary>
    /// Gets a boolean value from the configuration dictionary, using a default value if the key
    /// does not exist
    /// </summary>
    /// <param name="key">The key of the configuration entry to get</param>
    /// <param name="defaultValue">The default value</param>
